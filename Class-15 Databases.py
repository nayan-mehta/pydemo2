...
#     cursor = con.cursor()
#
#     query = 'create table employee(eno int(5) primary key, ename varchar(10), eage int(3), eincome double(10,2))'
#
...
#     cursor = con.cursor()
#
#     query = "insert into employee(eno, ename, eage, eincome) \
#     values(%s, %s, %s, %s)"
#
...
#     cursor = con.cursor()
#
#     query = "update employee set eage=eage+1 where ename = 'def'"
#
#     cursor.execute(query)
#
#     con.commit()
...
#     age = input('Enter age: ')
#
#     query = "delete from employee where eage='%s'" % (age)
#
#     cursor.execute(query)
#
#     con.commit()
